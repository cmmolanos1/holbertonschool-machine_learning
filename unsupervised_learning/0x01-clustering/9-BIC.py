...
def BIC(X, kmin=1, kmax=None, iterations=1000, tol=1e-5,
        verbose=False):
    """ Write a function def BIC(X, kmin=1, kmax=None, iterations=1000,
    tol=1e-5,
    ...
    You should use expectation_maximization = __import__('7-EM')
    .expectation_maximization
    You may use at most 1 loop
    Returns: best_k, best_result, l, b, or None, None, None,
    None on failure
